...
const TIPS = [
  ...
  "Press {highlight}<leader>Shift+S{/highlight} to stop voice talk-back",
  "Press {highlight}<leader>p{/highlight} to cycle voice profiles",
  ...
  "Type {highlight}/vs{/highlight} to stop voice talk-back",
  "Type {highlight}/vp{/highlight} to cycle voice profiles",
