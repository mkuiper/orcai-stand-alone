...
const TIPS = [
  ...
  "Press {highlight}F8{/highlight} to push-to-talk and transcribe audio",
  "Press {highlight}F7{/highlight} to toggle voice talk-back",
  "Press {highlight}F9{/highlight} to toggle voice auto-send",
