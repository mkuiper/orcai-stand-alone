...
const TIPS = [
  ...
  "Orcai is an experimental fork of OpenCode",
  ...
  "Press {highlight}<leader>v{/highlight} to push-to-talk and transcribe audio",
  "Press {highlight}<leader>m{/highlight} to toggle conversation mode (auto-send + talk-back)",
  "Press {highlight}<leader>Shift+M{/highlight} to keep updating conversation notes",
  "Press {highlight}<leader>V{/highlight} to toggle voice talk-back",
  "Press {highlight}<leader>a{/highlight} to toggle voice auto-send",
  "Type {highlight}/v{/highlight} to trigger voice input",
  "Type {highlight}/cm{/highlight} to toggle conversation mode",
  "Type {highlight}/notes{/highlight} to toggle conversation notes",
  "Type {highlight}/tb{/highlight} to toggle voice talk-back",
  "Type {highlight}/va{/highlight} to toggle voice auto-send",
  ...
  "Orcai auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "Orcai auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "Orcai uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent Orcai from reading sensitive files",
  "Use {highlight}opencode run{/highlight} for non-interactive scripting",
  "Use {highlight}opencode run --continue{/highlight} to resume the last session",
  "Use {highlight}opencode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}opencode serve{/highlight} for headless API access to Orcai",
